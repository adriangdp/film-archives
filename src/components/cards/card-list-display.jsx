        ...
        <div className={`
            ...
            ${
                oneLiner ?
                    ...
                    :
                    "md:w-11/12 lg:w-11/12 mx-auto md:mx-0 overflow-x-hidden overflow-y-visible flex-wrap items-center justify-start lg:justify-start gap-x-1 md:gap-x-12 gap-y-12 md:gap-y-10"
            }
        `}
        >
                {children}          
